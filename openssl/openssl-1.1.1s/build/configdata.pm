...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  AS => "arm-fullhanv3-linux-uclibcgnueabi-as",
  CC => "arm-fullhanv3-linux-uclibcgnueabi-gcc",
  CFLAGS => [ "-mcpu=cortex-a7 -mfloat-abi=hard -mfpu=neon-vfpv4" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-mcpu=cortex-a7 -mfloat-abi=hard -mfpu=neon-vfpv4" ],
  CPPINCLUDES => [  ],
  CXX => "arm-fullhanv3-linux-uclibcgnueabi-g++",
  CXXFLAGS => [ "-mcpu=cortex-a7 -mfloat-abi=hard -mfpu=neon-vfpv4" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LD => "arm-fullhanv3-linux-uclibcgnueabi-ld",
  LDFLAGS => [ "-L/home/l/share/sda4/spark_srs_ptz/lib/fuhan8852/opensrc" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)arm-fullhanv3-linux-uclibcgnueabi-gcc",
  minor => "1.1",
  ...
  prefix => "/home/l/share/sda4/unit-test/openssl/openssl-1.1.1s/build/install",
  processor => "",
